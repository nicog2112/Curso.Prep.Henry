...
function redondearNumero(num) {
  ...
  // Tu código:
  var enteroMasProximo = Math.round(num);
  return enteroMasProximo;
...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var enteroMasProximoHaciaArriba = Math.ceil(num);
  return enteroMasProximoHaciaArriba;
}
